...
#  find the missing integer numbers that contains 1 to 10
# n series equation
...
def find_missing_number(list, noOfElement):
    sum1 = noOfElement(noOfElement+1)/2
    sum2 = sum(list)

    return sum1-sum2


print(find_missing_number(mylist, 100))
